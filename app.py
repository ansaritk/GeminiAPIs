...
def user_input(user_question):
    if st.session_state.get('processing_done', True):
        embeddings = GoogleGenerativeAIEmbeddings(model = "models/embedding-001")
...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        pdf_docs = st.file_uploader("Upload your PDF Files and Click on the Confirm & Submit Button", accept_multiple_files=True)
